              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div 
                    ...
                    className="p-5 rounded-xl border border-slate-850 hover:border-slate-805 bg-slate-900/35 hover:bg-slate-900/60 transition-all duration-200 cursor-pointer flex items-start gap-4 group"
                  >
