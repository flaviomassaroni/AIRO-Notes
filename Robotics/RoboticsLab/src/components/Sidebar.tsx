...
export const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection }) => {
  const menuItems = [
    ...
    {
      id: 'inverse_diff_lab' as ActiveSection,
      label: 'IDK & Null-Space Lab',
      subtitle: 'DLS & Inseguimento Tr.',
      icon: Workflow,
      color: 'text-[#06b6d4]',
    },
    {
      id: 'statics_lab' as ActiveSection,
      label: 'Statica Duale',
      subtitle: 'Equilibrio \u03C4 = J\u1D40 F',
      icon: Zap,
      color: 'text-pink-400',
    },
    {
      id: 'orientation_lab' as ActiveSection,
      label: 'Rappresentazioni SO(3)',
      subtitle: 'T(\u03C6), d\u03C6/dt & SLERP',
      icon: Rotate3d,
      color: 'text-[#a855f7]',
    },
  ];
