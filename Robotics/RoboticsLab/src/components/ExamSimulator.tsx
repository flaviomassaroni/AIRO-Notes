    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      ...
      <div className="border-b border-slate-800 pb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 bg-slate-900 border border-slate-800 px-3 py-1 rounded-lg">
          <Award className="w-4 h-4 text-brand-warning text-amber-500" />
      ...
      {!complete ? (
        <div className="space-y-6">
          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-6 relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
              <span className="text-[10px] font-mono tracking-widest text-cyan-400 uppercase bg-cyan-950/40 border border-cyan-800/40 px-2.5 py-0.5 rounded text-purple-400 border-purple-800/40 bg-purple-950/40">
          ...
          {selectedOption !== null && (
            <div className="bg-slate-900/40 border border-slate-850 p-5 rounded-xl space-y-3 animate-fade-in">
              ...
              <button
                ...
                className="w-full text-center py-2 rounded-lg bg-cyan-950 text-cyan-400 border border-cyan-800/60 hover:bg-cyan-900 text-xs font-bold transition-colors cursor-pointer mt-2 bg-purple-950 text-purple-300 border-purple-800/60 hover:bg-purple-900"
              >
        ...
        <div className="bg-slate-900/30 border border-slate-800 p-8 rounded-xl text-center space-y-6">
          <div className="inline-flex p-4 bg-purple-950/50 text-purple-400 rounded-full border border-purple-800/40">
          ...
          <div className="max-w-xs mx-auto bg-slate-950 p-5 rounded-lg border border-slate-850 space-y-2">
            <div className="flex justify-between text-xs font-mono">
              ...
              <span className="text-cyan-400 font-bold text-purple-400">{score} Punti</span>
            </div>
            <div className="flex justify-between text-xs font-mono">
              <span className="text-slate-400">Esito Percentuale:</span>
              <span className="text-brand-successo font-bold text-emerald-400">
          ...
          <button
            onClick={restartQuiz}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-cyan-950 text-cyan-400 border border-cyan-800/80 hover:bg-cyan-900 text-xs font-bold transition-colors cursor-pointer bg-purple-950 border-purple-800/80 text-purple-300 hover:bg-purple-900"
          >
