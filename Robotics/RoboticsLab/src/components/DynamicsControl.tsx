    ...
    <div className="space-y-6 animate-fade-in text-slate-100">
      ...
      <div className="border-b border-slate-800 pb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 self-start md:self-center bg-cyan-950/40 hover:bg-cyan-900/30 text-cyan-400 hover:text-cyan-300 border border-cyan-900/60 px-3.5 py-2 text-xs font-display font-medium rounded-lg transition-all cursor-pointer whitespace-nowrap bg-sky-950/40 border-sky-900/60 hover:bg-sky-900/30 text-sky-400 hover:text-sky-300"
        >
        ...
        <div className="lg:col-span-5 space-y-5">
              ...
              <div className="p-3 bg-slate-950/40 rounded-lg border border-slate-850 flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-[10px] text-slate-400 font-sans leading-tight">
                    Somma algebricamente <span className="font-mono text-sky-400">g(q)</span> all'output della coppia
                  </p>
                </div>
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full accent-sky-450 text-xs"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full accent-purple-450 text-xs"
                  />
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 pt-2 border-t border-slate-850/60">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-[11px] font-mono">
                      ...
                      <span className="text-cyan-400 font-bold text-sky-400">{kp.toFixed(1)}</span>
                    </div>
                    <input
                      type="range"
                      min="1"
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between text-[11px] font-mono">
                      ...
                      <span className="text-cyan-400 font-bold text-purple-400">{kd.toFixed(1)}</span>
                    </div>
                    <input
                      type="range"
                      min="0.1"
                      ...
                      className="w-full accent-cyan-500 accent-purple-500 text-xs"
                    />
                  </div>
                </div>
              </div>
          ...
          <div className="bg-slate-900/30 border border-slate-800 p-5 rounded-xl space-y-4">
            ...
            <div className="font-mono text-[11px] p-3 bg-slate-950 rounded-lg border border-slate-850 leading-relaxed text-slate-300">
              <span className="text-[9px] text-cyan-400 font-bold tracking-wider uppercase block border-b border-slate-850/60 pb-1 mb-1.5 text-sky-400">
              ...
              <div className="space-y-1">
                ...
                <div className="flex justify-between border-t border-slate-850/60 pt-1 mt-1 font-bold">
                  ...
                  <span className="text-cyan-400 text-sky-400">{telemetry.tau1.toFixed(3)} Nm</span>
                </div>
      ...
      {isGuideOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/85 backdrop-blur-md p-4 animate-fade-in">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl relative">
            {/* Header */}
            <div className="p-5 border-b border-slate-800 flex items-center justify-between bg-slate-900 sticky top-0 z-10 w-full shrink-0">
              <div className="flex items-center gap-2.5">
                <BookOpen className="w-5 h-5 text-cyan-400 text-sky-400" />
                <span className="font-display font-semibold text-base text-white">
                  Guida Didattica: Dinamica & Controllo continuo
                </span>
              </div>
              <button
                onClick={() => setIsGuideOpen(false)}
                className="p-1.5 rounded-lg hover:bg-slate-800 text-slate-400 hover:text-slate-100 transition-all cursor-pointer bg-slate-900 border border-slate-800"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6 overflow-y-auto space-y-6 text-sm text-slate-300 leading-relaxed font-sans max-h-full">
              ...
              <div className="space-y-2">
                <h3 className="font-display font-semibold text-cyan-400 flex items-center gap-1 text-sky-400">
                ...
                <div className="p-3 bg-slate-950 rounded-lg border border-slate-850 text-center font-mono text-cyan-300 text-sky-300 flex justify-center items-center gap-1 py-4">
              ...
              {/* Controller Details */}
              <div className="space-y-2">
                <h3 className="font-display font-semibold text-cyan-400 text-sky-400">
              ...
              <div className="bg-slate-950/50 p-4 rounded-xl border border-slate-800 space-y-2">
                ...
                <ol className="list-decimal pl-5 text-xs text-slate-400 space-y-1.5">
                  ...
                  <li>Prova ad incrementare <code className="text-cyan-305 font-mono text-sky-400">Kp</code> per diminuire tale errore. Noterai che riduce la distanza, ma i giunti iniziano ad oscillare repentinamente se non aumenti proporzionalmente anche <code className="text-cyan-305 font-mono text-purple-400">Kd</code>.</li>
            ...
            {/* Footer */}
            <div className="p-4 border-t border-slate-850 bg-slate-900 text-right shrink-0">
              <button
                onClick={() => setIsGuideOpen(false)}
                className="py-2.5 px-6 bg-cyan-500 hover:bg-cyan-400 hover:scale-105 text-slate-950 text-xs font-bold rounded-lg transition-all cursor-pointer bg-sky-500 hover:bg-sky-400"
              >
                Ho Capito!
              </button>
            </div>
