...
Between 55\% and 75\% of survivors have chronic upper limb motor deficit which compromises autonomy 
in daily activities \cite{proietti2024combining}. Donkor \cite{donkor2018stroke} contextualizes this figure in the perspective of quality of life:
...
Functionally, this dose deficit translates into outcomes: the Ren 
et al.\ meta-analysis \cite{ren2024effect} of 10 RCTs (290 patients) 
reports a standardized mean difference of SMD\,=\,0.50 (95\,\% CI: 
0.26--0.73) in favour of BCI-triggered over conventional therapy --- 
a gap that reflects the systematic inability of standard care to 
activate neuroplastic mechanisms at the required dose, not a 
difference in treatment target.
