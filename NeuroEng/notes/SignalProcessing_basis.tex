...
\usepackage{parskip}
\usepackage[T1]{fontenc}
\usepackage{booktabs} % Necessario per \toprule, \midrule, \bottomrule
...
\midrule
\textbf{Campionamento (Sampling)} & Discretizzazione dell'asse del \textit{tempo}: si misura il segnale ogni $T_C$ secondi. \\
\textbf{Quantizzazione (Quantization)} & Discretizzazione dell'asse dell'\textit{ampiezza}: ogni campione viene arrotondato al livello consentito più vicino. \\
\bottomrule
\end{tabular}
\end{center}
